 ...
 * @implement Segment
 */
class LogicalSegment extends segment_1.Segment {
    /**
     * @constructor
    ...
    constructor(type, format, value) {
        ...
        super(segment_type_1.SegmentType.LOGICAL);
        this._type = type;
        this._format = format;
        this._logicalProcessor = logical_format_1.getLogicalProcessor(this._format);
    ...
    get length() {
        if (this._logicalProcessor) {
            ...
            if (this._format == logical_format_1.LogicalFormat.BIT_8) {
    ...
    */
    ...
    encode() {
        if (this._logicalProcessor != undefined) {
            ...
            const type = logical_type_1.encodeLogicalType(this._type);
   ...
   */
    toJSON() {
        if (this._type != -1 &&
            ...
            return {
                segment: 'LOGICAL',
                type: logical_type_1.LogicalType[this._type],
                format: logical_format_1.LogicalFormat[this._format],
                value: this._value
            };
        }
        else {
...
exports.LogicalSegment = LogicalSegment;
